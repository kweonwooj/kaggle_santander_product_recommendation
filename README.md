...
Luckily, I was able to use this competition as a study material for FASTCAMPUS CAMP.

## Related works
- Current state-of-the-art recommendation systems follow two main streams (did not dig in)
...
- Exploratory Data Analysis
  ...
  - Check for NAs
  - Check for distribution, histograms of each features
  - Check for relationship between train and test features
- Data Preprocessing
  - Use 2015-06 as train data
  - change 24 binary targets into single integer target 
- Feature Engineering
  - add lag-5 features
  - feature engineering
    - monthly purchase amount, cumulative purchase amount etc
- Model Selection
  - XGBoost 
- Evaluation Metric
  - mlogloss
